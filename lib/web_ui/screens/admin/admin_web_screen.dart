...
class _AdminWebScreenState extends State<AdminWebScreen> {
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    // Turnaround Buffer Settings Button
                    OutlinedButton.icon(
                      onPressed: () => _showGlobalTurnaroundBufferDialog(isDark),
                      icon: const Icon(
                        Icons.cleaning_services_rounded,
                        size: 16,
                        color: AppColors.primary,
                      ),
                      label: const Text('Return Cleaning Buffer'),
  ...
  void _showGlobalTurnaroundBufferDialog(bool isDark) async {
    final currentBuffer =
        ...
        builder: (context, setModalState) => AlertDialog(
          ...
          content: SizedBox(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'Set the default automatic unlist duration when a car is returned. The car will be unlisted for cleaning and inspection for this duration before automatically relisting.',
                  style: TextStyle(
                    fontSize: 13,
                ...
                Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<int>(
                      ...
                      isExpanded: true,
                      dropdownColor:
                          isDark ? const Color(0xFF0B2238) : Colors.white,
                ...
                const SizedBox(height: 12),
                Text(
                  'Note: Partners and admins can override this per vehicle or click "Relist Immediately" anytime if cleaning finishes early.',
                  style: TextStyle(
                    fontSize: 11,
                    color: isDark ? Colors.white38 : Colors.grey.shade500,
              ...
              onPressed: () async {
                ...
                if (mounted) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text(
                        'Global turnaround buffer set to ${VehicleTurnaroundService.getLabelForMinutes(selectedBuffer)}',
                      ),
                      backgroundColor: AppColors.success,
                    ),
                  );
  ...
  void _showAdminVehicleDetailsDialog(
    ...
    showDialog(
      ...
      builder: (dialogContext) {
        ...
        int currentTurnaroundMinutes = 60;
        Map<String, dynamic>? activeTurnaround;
        bool isTurnaroundLoaded = false;
        bool isRelisting = false;

        return StatefulBuilder(
          builder: (context, setModalState) {
            if (!isTurnaroundLoaded) {
              isTurnaroundLoaded = true;
              VehicleTurnaroundService()
                  .getVehicleTurnaroundMinutes(vehicleId)
                  .then((mins) {
                if (dialogContext.mounted) {
                  setModalState(() => currentTurnaroundMinutes = mins);
                }
              });
              VehicleTurnaroundService()
                  .getActiveTurnaround(vehicleId)
                  .then((turnaround) {
                if (dialogContext.mounted) {
                  setModalState(() => activeTurnaround = turnaround);
                }
              });
            }
            return Dialog(
                              ...
                              builder: (context, constraints) {
                                ...
                                return Wrap(
                                  ...
                                  children: [
                                    ...
                                    // Section 5: Return Turnaround Buffer & Cleaning Automation
                                    SizedBox(
                                      width: colWidth,
                                      child: _buildVehicleSpecSectionCard(
                                        'RETURN CLEANING & TURNAROUND',
                                        Icons.cleaning_services_rounded,
                                        isDark,
                                        [
                                                ...
                                                children: [
                                                  const Row(
                                                    children: [
                                                      ...
                                                      Expanded(
                                                        child: Text(
                                                          'Currently Unlisted for Cleaning',
                                                          style: TextStyle(
                                                            fontSize: 11,
                                                            fontWeight:
                                                                FontWeight
                                          ...
                                          const SizedBox(height: 8),
                                          Text(
                                            'Vehicle automatically unlists upon return for this duration for cleaning/inspection before becoming bookable again.',
                                            style: TextStyle(
                                              fontSize: 10.5,
                                              color: isDark
                                                  ? Colors.white38
