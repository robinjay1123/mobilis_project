...
class AdminService {
  ...
  Future<void> suspendUser(String userId, String reason) async {
    try {
      ...
      await supabase
          ...
          .update({
            'is_active': false,
            // restriction_reason, suspension_reason, suspended_at all dropped in migration 20260923000200
          })
          .eq('id', userId);
    ...
    try {
      ...
      if (existingPvId != null && existingPvId.isNotEmpty) {
        ...
        final partnerVehicle = await supabase
            ...
            .select('id')
            .single();
        partnerVehicleId = partnerVehicle['id'].toString();
      }
  ...
  Future<void> rejectVehicleApplication(
    ...
    try {
      ...
      final application = await supabase
          .from('partner_vehicle_applications')
          .select('partner_vehicle_id,plate_number')
          .eq('id', applicationId)
          .single();
      await supabase
          .from('partner_vehicle_applications')
