...
class _DashboardScreenState extends State<DashboardScreen> {
            ...
            children: [
              ...
              SizedBox(
                ...
                child: OutlinedButton(
                  ...
                  child: const Text(
                    'Edit Details & Missing Documents',
                    style: TextStyle(fontWeight: FontWeight.w700),
                  ),
                ),
              ),
  ...
  List<Map<String, dynamic>> _uiConversations() {
    return _conversations.map((conversation) {
      ...
      var convImage = conversation['vehicle_image_url']?.toString() ?? '';
      if (convImage.isEmpty) {
        convImage = (booking?['vehicle_image_url'] ??
                vehicle?['image_url'] ??
                vehicle?['imageUrl'] ??
                vehicle?['photo_url'] ??
    ...
    if (lateHours > 0) {
      ...
      try {
        ...
        await ReturnInspectionNoticeModal.show(
          context,
          vehicleTitle: booking['carName']?.toString() ??
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () async {
                      final image = await _pickReceiptImageWithSource(context);
                      if (image != null) {
                          ...
                          Flexible(
                            child: Text(
                              pickedReceipt != null
                                  ...
                                  : 'Upload Payment Receipt (Camera or Gallery)',
                              overflow: TextOverflow.ellipsis,
                              style: TextStyle(
                                color: pickedReceipt != null
                                    ? AppColors.primary
                        ...
                        children: [
                          ...
                          Text(
                            pickedReceipt != null
                                ...
                                : 'Upload Payment Receipt Proof (Camera or Gallery)',
                            overflow: TextOverflow.ellipsis,
                            style: TextStyle(
                              color: pickedReceipt != null
                                  ? AppColors.primary
