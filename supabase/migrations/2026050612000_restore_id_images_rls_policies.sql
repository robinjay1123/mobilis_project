-- Restore ID images storage RLS policies
-- This migration restores the policies that were previously removed
...
-- Allow authenticated users to upload only inside their own folder (verifications/<user_id>/...)
